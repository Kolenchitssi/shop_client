...
// import { dateFormat } from "utils/date-formatters";
...
const TextFieldBase: FunctionComponent<TextFieldBaseProps> = memo((props) => {
  const {
    inputRef,
    value,
    onChange,
  ...
  const endAdornment = useMemo(
    () => (
      <>
        ...
        {isClearable &&
          (!!value || value === 0) &&
          (!disabled || (disabled && monthPickerFormat)) &&
          !isLoading && (
    ...
    [isLoading, isClearable, value, disabled, onClear, BacksWordIcon, Suffix]
  );
